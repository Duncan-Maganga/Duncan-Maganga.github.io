...
const projects = [
    { title: "Secure File Sharing System.", description: "I built a Secure File Sharing System that protects business data with encryption and secure key management, reducing breach risks and enabling safe file sharing.", link: "https://github.com/Duncan-Maganga/FUTURE_CS_003", markdown: "projects/project3.md" },
    { title: "Web Application Vulnerability Assessment Report", description: "I evaluated a web application for security weaknesses and provided recommendations to fix them and improve its protection.", link: "https://github.com/Duncan-Maganga/FUTURE_CS_001", markdown: "projects/project2.md" },
    //{ title: "Project 3", description: "Designed and executed a phishing campaign to demonstrate how attackers trick users and how organizations can strengthen defenses through awareness training and simulations.", link: "https://github.com/Duncan-Maganga/project3", markdown: "project3.md" },
    { title: "Phishing Simulation with Gophish", description: "Designed and executed a phishing campaign to demonstrate how attackers trick users and how organizations can strengthen defenses through awareness training and simulations.", link: "https://github.com/Duncan-Maganga/Phishing-Simulation-with-GoPhish", markdown: "projects/project1.md" },
...
const writeups = [
    ...
    { title: "Service Endpoints and Securing Storage.", 
        description: "In this lab, I secured Azure Storage by designing a virtual network with public and private subnets, applying network security groups, and restricting storage access to a private subnet only. The most valuable moment was testing the setup myself—access succeeded where it was allowed and failed where it wasn’t, proving that the controls were actually enforcing least privilege. This hands-on work reinforced that cloud security isn’t about configurations on paper, but about intentional design, validation, and taking responsibility for protecting data in real-world environments.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup32.md", markdown: "writeups/writeup32.md" },
    { title: "Securing Azure SQL Database", 
        description: "In this lab, I secured an Azure SQL Database by implementing built-in protection, visibility, and auditing features. I enabled Microsoft Defender for SQL to provide threat detection and vulnerability assessment, classified sensitive data to support compliance and data protection requirements, and configured both server-level and database-level auditing to track logins and query activity. This exercise strengthened my understanding of how Azure protects databases against common attacks, improves data governance, and provides audit trails that are critical for incident detection, compliance, and trust in real-world cloud environments.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup33.md", markdown: "writeups/writeup33.md" },
    { title: "Role-Based Access Control.", 
        description: "In this lab, I implemented Azure Role-Based Access Control by creating users and security groups in Microsoft Entra ID and managing access through group-based role assignments. I used the Azure Portal, PowerShell, and Azure CLI to demonstrate different administrative approaches for identity and access management. Users were organized into Senior Admins, Junior Admins, and Service Desk groups, and permissions were assigned at the resource group level using the Virtual Machine Contributor role. This lab reinforced the principle of least privilege and showed how group-based RBAC improves access control, scalability, and accountability in real-world Azure environments.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup34.md", markdown: "writeups/writeup34.md" },
    { title: "Network Security Groups and Application Security Groups.",
        description: "In this lab, I set up a secure Azure network using Network Security Groups and Application Security Groups. I separated web servers and management servers into different security groups and applied rules to control access. Web servers were allowed to receive HTTP/HTTPS traffic from the internet, while RDP access was restricted only to management servers. I tested the setup by accessing the IIS web page publicly and confirming that only the management server allowed RDP. This lab shows my ability to configure and validate basic network security controls in Azure.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup35.md", markdown: "writeups/writeup35.md" },
    { title: "Configure Security Recommendations for an Azure Virtual Machine", 
        description: "This project demonstrates hands-on experience securing an Azure SQL Database using Microsoft Defender for Cloud. It covers deploying a managed Azure SQL database, enabling Microsoft Defender for SQL, running vulnerability assessments, managing security baselines, and applying data classification recommendations. The lab highlights practical skills in identifying database risks, validating security posture, and using Defender insights to reduce exposure and strengthen cloud-native database security.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup36.md", markdown: "writeups/writeup36.md" },
    ...
    { title: "Configure Security for an Azure Cosmos DB Account", 
        description: "This lab focuses on securing an Azure Cosmos DB account by deploying the service, creating and querying data, and then locking down access using network controls and role-based access control. It demonstrates how to restrict access through VNets, service endpoints, firewall rules, and least-privilege permissions, and verifies security by intentionally testing and denying unauthorized actions.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup38.md", markdown: "writeups/writeup38.md" },
    { title: "Configure Azure Disk Encryption.", 
        description: "This lab demonstrates how to secure Azure storage by creating a virtual machine, adding a data disk, and enabling Azure Disk Encryption using Azure Key Vault to protect both OS and data disks at rest.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup39.md", markdown: "writeups/writeup39.md" },
    { title: "Configure an Application Security Group", 
        description: "This lab walks through securing a web server in Azure by setting up a virtual network, application security group, and network security group. You deploy a Windows VM, apply security rules for web and RDP access, install IIS, and verify connectivity. The exercise shows how ASGs and NSGs work together to control traffic and protect resources in Azure.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup40.md", markdown: "writeups/writeup40.md" },
    { title: "Can You Harden Virtual Machines in Azure? [Advanced]", 
        description: "This writeup demonstrates how to harden an Azure virtual machine using AZ-500 best practices by securing network access with NSGs and ASGs, deploying a web workload safely, and protecting data with Azure Key Vault and Azure Disk Encryption.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup41.md", markdown: "writeups/writeup41.md" },
    { title: "Can You Enable Secure Virtual Machines and Application Services? [Advanced]", 
        description: "This writeup showcases an advanced AZ-500 lab where Azure virtual machines and application services are secured by enforcing identity and access controls, hardening VMs with antimalware and disk encryption, restricting RDP access, and enabling Application Insights to monitor and validate security events in real time.", 
        link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup42.md", markdown: "writeups/writeup42.md" },
    { title: "Can You Configure Network Security to Allow Application Traffic? [Advanced].", 
       description: "This writeup demonstrates the design and implementation of a secure multi-tier Azure network by configuring virtual networks, VNet peering, virtual machines for web, application, and database tiers, and network security groups to control application traffic in alignment with AZ-500 secure networking principles.",
       link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup43.md", markdown: "writeups/writeup43.md" },
    ...
    { title: "Create a Log Analytics Workspace, Azure Storage Account, and Data Collection Rule (DCR).", 
      description: "This write-up outlines how I deployed core monitoring, security, and incident-response capabilities in Azure using Log Analytics, storage, Defender for Cloud, JIT access, and Microsoft Sentinel.", 
      link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup46.md", markdown: "writeups/writeup46.md" },
    { title: "VLANs and Secure Switch Configuration.", 
      description: "This project focused on network hardening through VLAN segmentation and Layer 2 security features like port security, DHCP snooping, and BPDU Guard. Unused ports were secured, and sticky MAC addresses were configured to prevent unauthorized access, strengthening overall LAN stability and protection.", 
      link: "https://github.com/Duncan-Maganga/Duncan-Maganga.github.io/blob/main/writeups/writeup47.md", markdown: "writeups/writeup47.md" },
